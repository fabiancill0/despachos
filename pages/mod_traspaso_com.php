...
?>
    ...
    <head>
        <title>Traspaso Comercial</title>
        <!-- Required meta tags -->
        <meta charset="utf-8" />
        <meta
            name="viewport"
        ...
        <script src="../js/mod_traspaso_com.js?<?= md5(time()) ?>"></script>
    ...
    <body>
        <nav class="navbar navbar-expand-sm">
            <div class="container-fluid">
                <span class="navbar-brand mb-0 h1">Traspaso Comercial</span>
                ...
                <div class="modal-dialog modal-dialog-scrollable modal-fullscreen">
                    <div class="modal-content">
                        <div class="modal-header" id="header_pallet">
                            <h1 class="modal-title fs-5" id="exampleModalLabel">Añadir Tarjas</h1>
