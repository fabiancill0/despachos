<?php
session_start();
if ($_SESSION['login_type'] != 0 && $_SESSION['login_active'] != 0) {
        ...
        <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <form action="model/logout.php" method="post" class="d-flex">
                        <button class="btn btn-outline-danger" type="submit" name="out"><i class="fa-solid fa-right-from-bracket"></i> Salir</button>
                    </form>
                </div>
            </div>
        </nav>
